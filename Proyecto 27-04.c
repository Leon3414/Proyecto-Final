...
void buscarpelicula();
void seleccionar();
struct pelicula agregarpelicula(struct pelicula peliculas[9]);
    ...
    switch(menu){ //aqui esta el menu entre el cliente o empleado
        case 1:
            ...
            switch(menucliente){ // este es el munu de los clientes
                case 1:
                    imprimircartelera(pelicula peliculas[9]);
                    break;
                case 2:
                    imprimirprecios();
                    break;
        ...
        case 2:
            ...
            switch(menuempleado){ //este es el menu de los empleados
                case 1:
                   ...
                   break;
                case 2:
                    agregarpelicula(char fecha, char genero, int duracion, char estudio, char director, char horarios);
                    break;
                case 3:
                    eliminarpelicula(struct pelicula peliculas[9]);
                    break;
                case 4:
                    return 0;
                 default:
